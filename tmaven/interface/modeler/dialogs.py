...
from PyQt5.QtWidgets import (QDialog, QPushButton, QProgressBar, QStyleFactory,
								QGridLayout, QLabel, QSpinBox, QLayout, QLineEdit,
...
def dialog_vbmm(gui,fxn,title,model_selection=False,include_TM=True):
